...
export const products: Product[] = [
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'multispectral-camera',
    gallery: ['multispectral-camera'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'forestry-boundary-mapping-services',
    gallery: ['forestry-boundary-mapping-services'],
  ...
  // --- Camera Traps (Generic Families) ---
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'ir-camera-trap',
    gallery: ['ir-camera-trap'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'white-flash-camera-trap',
    gallery: ['white-flash-camera-trap'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'gsm-camera-trap',
    gallery: ['gsm-camera-trap'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'solar-camera-trap',
    gallery: ['solar-camera-trap'],
  ...
  // --- Thermal & Night Observation Products ---
  {
    ...
    brand: 'Seek Thermal',
    category: 'thermal',
    image: 'seek-thermal-camera',
    gallery: ['seek-thermal-camera'],
  ...
  },
  {
    ...
    brand: 'HIKMICRO',
    category: 'thermal',
    image: 'hikmicro-habrok-multi-spectrum-binocular',
    gallery: ['hikmicro-habrok-multi-spectrum-binocular'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'wildlife-microphone',
    gallery: ['wildlife-microphone'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'ultrasonic-wildlife-detector',
    gallery: ['ultrasonic-wildlife-detector'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'acoustic-sensor',
    gallery: ['acoustic-sensor'],
  ...
  // --- Wildlife Tracking (GPS Collars) ---
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'gps-wildlife-tracking-collar',
    gallery: ['gps-wildlife-tracking-collar'],
  ...
  // --- Security & Surveillance (Generic Families) ---
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'solar-cctv-camera',
    gallery: ['solar-cctv-camera'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'cctv-surveillance-camera',
    gallery: ['cctv-surveillance-camera'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'chainsaw-protection',
    gallery: ['chainsaw-protection'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'high-visibility-clothing',
    gallery: ['high-visibility-clothing'],
  ...
  // --- Weather Monitoring ---
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'climate-monitoring-equipment',
    gallery: ['climate-monitoring-equipment'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'portable-weather-station',
    gallery: ['portable-weather-station'],
  ...
  // --- Power & Field Electronics ---
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'portable-power-station',
    gallery: ['portable-power-station'],
  ...
  },
  {
    ...
    brand: 'AFFORDA',
    category: 'forestry',
    image: 'waterproof-case',
    gallery: ['waterproof-case'],
  ...
  // --- 1. Geological Compasses & Clinometers ---
  {
    ...
    brand: 'Brunton',
    category: 'geology',
    image: 'brunton-geo-pocket-transit-f-5010',
    gallery: ['brunton-geo-pocket-transit-f-5010'],
  ...
  },
  {
    ...
    brand: 'Brunton',
    category: 'geology',
    image: 'brunton-truarc-15',
    gallery: ['brunton-truarc-15'],
  ...
  },
  {
    ...
    brand: 'Brunton',
    category: 'geology',
    image: 'brunton-truarc-20',
    gallery: ['brunton-truarc-20'],
  ...
  },
  {
    ...
    brand: 'Brunton',
    category: 'geology',
    image: 'brunton-truarc-5',
    gallery: ['brunton-truarc-5'],
  ...
  },
  {
    ...
    brand: 'Estwing',
    category: 'geology',
    image: 'estwing-e3-23lp',
    gallery: ['estwing-e3-23lp'],
  ...
  },
  {
    ...
    brand: 'Estwing',
    category: 'geology',
    image: 'estwing-engineers-hammer-e6-48e',
    gallery: ['estwing-engineers-hammer-e6-48e'],
  ...
  },
  {
    ...
    brand: 'Estwing',
    category: 'geology',
    image: 'estwing-rock-pick-square-head-e6-24pc',
    gallery: ['estwing-rock-pick-square-head-e6-24pc'],
  ...
  // --- 3. Geological Prospecting & Gold Pans ---
  {
    ...
    brand: 'Estwing',
    category: 'geology',
    image: 'estwing-plastic-gold-pan',
    gallery: ['estwing-plastic-gold-pan'],
  ...
  },
  {
    ...
    brand: 'Estwing',
    category: 'geology',
    image: 'estwing-steel-gold-pan',
    gallery: ['estwing-steel-gold-pan'],
...
,
...

  {
    ...
    name: 'HIKMICRO CONDOR LRF 2.0 Thermal Monocular',
    brand: 'HIKMICRO',
    category: 'thermal',
    image: 'hikmicro-condor-lrf-2-0',
    gallery: ['hikmicro-condor-lrf-2-0'],
    label: 'ULTRA-SENSITIVE THERMAL LRF MONOCULAR',
    summary: 'Next-generation thermal observation monocular series featuring sub-15 mK NETD sensitivity, integrated 1,000 m laser rangefinder, shutterless HSIS continuous imaging, and 1920x1080 OLED display, available in CQ35L 2.0 and CQ50L 2.0 configurations.',
    specs: [
      ['Product Series', 'HIKMICRO CONDOR LRF 2.0 Series'],
      ['Available Models', 'CQ35L 2.0 (35 mm lens) / CQ50L 2.0 (50 mm lens)'],
      ['Thermal Sensor Resolution', '640 × 512 uncooled VOx detector (12 μm, NETD < 15 mK)'],
      ['Integrated Laser Rangefinder', 'Integrated LRF up to 1,000 m (±1 m accuracy)'],
      ['Display', '0.49-inch 1920 × 1080 OLED display'],
      ['Shutter System', 'HSIS (HIKMICRO Shutterless Image System) for uninterrupted viewing'],
      ['Detection Range', 'Up to 1,800 m (CQ35L 2.0) / Up to 2,600 m (CQ50L 2.0)'],
      ['Objective Focal Length', '35 mm (CQ35L 2.0) / 50 mm (CQ50L 2.0)'],
      ['Battery System', 'Replaceable rechargeable 21700 Li-ion battery (up to 6.5+ hours)'],
    ...
    features: [
      ...
      'HIKMICRO Shutterless Image System (HSIS) ensures a smooth, uninterrupted viewing experience without freeze frames',
      'High-resolution 1920x1080 0.49-inch OLED display paired with Image Pro 2.0 algorithms for exceptional clarity',
      'Available in multiple lens configurations (CQ35L 2.0 and CQ50L 2.0) to match medium-to-long range mission requirements',
      'Replaceable 21700 rechargeable battery system provides 6.5+ hours of continuous operation in remote sectors'
    ],
    page: 1,
...

  {
    ...
    label: 'PORTABLE FIELD TORCH',
    summary: 'Rugged handheld field torch engineered for outdoor operations, patrol, search tasks, and demanding environmental conditions.',
    specs: [
      ['Product Type', 'Portable Field Torch'],
      ['Application', 'Field Operations / Search / Patrol'],
      ['Carry Type', 'Handheld'],
      ['Power Configuration', 'Rechargeable / Model dependent'],
      ['Field Use', 'Outdoor and operational environments']
    ],
    features: [
      'Rugged construction engineered for demanding field and outdoor operational environments',
      'High-output illumination designed for perimeter inspection, search tasks, and patrol',
      'Ergonomic handheld profile with secure grip texture for field deployment',
      'Weather-resistant housing built to withstand diverse outdoor climates'
    ],
    page: 1,
...

  {
    ...
    label: 'HANDS-FREE FIELD HEADLAMP',
    summary: 'Rugged hands-free field headlamp engineered for night operations, field maintenance, expedition tasks, and outdoor patrols.',
    specs: [
      ['Product Type', 'Field Headlamp'],
      ['Application', 'Hands-Free Field Illumination'],
      ['Mounting', 'Adjustable Head Strap'],
      ['Power Configuration', 'Model dependent'],
      ['Field Use', 'Night fieldwork / maintenance / expeditions']
    ],
    features: [
      'Hands-free directional illumination for operational tasks and night navigation',
      'Comfortable and secure adjustable head strap for extended field wear',
      'Multiple lighting modes suited for both close-range inspection and area illumination',
      'Durable, weather-resistant construction suited for challenging field conditions'
    ],
    page: 1,
    subcategories: ['defense-field-operations', 'defense-tactical', 'forestry-camping-safety-climate'],
    categoryIds: ['defense', 'forestry'],
...

  {
    ...
    label: 'HELMET-MOUNTED LIGHT',
    summary: 'Hands-free helmet-mounted lighting system designed for direct helmet attachment in tactical, field, and industrial operations.',
    specs: [
      ['Product Type', 'Helmet-Mounted Light'],
      ['Application', 'Hands-Free Helmet Illumination'],
      ['Mounting', 'Helmet-compatible mounting system'],
      ['Power Configuration', 'Model dependent'],
      ['Field Use', 'Field / tactical / industrial operations']
    ],
    features: [
      'Secure helmet-compatible mounting engineered for hands-free operational tasks',
      'Low-profile design suited for tactical helmets and industrial hard hats',
      'Directional task lighting for inspection, navigation, and night operations',
      'Durable, impact-resistant housing built for rugged field use'
    ],
    page: 1,
...

  {
    ...
    label: 'INFRARED SEARCH & ILLUMINATION LIGHT',
    summary: 'High-performance infrared search and illumination light engineered for night-vision assisted surveillance, perimeter security, and nighttime field observation.',
    specs: [
      ['Product Type', 'Infrared Search / Illumination Light'],
      ['Application', 'Night-Vision Assisted Observation'],
      ['Output Type', 'Infrared'],
      ['Mounting / Carry', 'Model dependent'],
      ['Power Configuration', 'Model dependent']
    ],
    features: [
      'Dedicated infrared illumination designed to assist night-vision and thermal observation systems',
      'High-intensity output for perimeter monitoring, night reconnaissance, and security operations',
      'Rugged thermal-dissipating housing engineered for continuous nighttime duty cycles',
      'Versatile operational deployment options suited for stationary or mobile field use'
    ],
    page: 1,
