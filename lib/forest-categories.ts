export const forestSubcategories = [
  { id: 'forest-survey', name: 'Forest Survey & Measurement Equipment', slug: 'forest-survey' },
  { id: 'forest-inventory', name: 'Forest Inventory & Monitoring', slug: 'forest-inventory' },
  { id: 'wildlife-monitoring', name: 'Wildlife Monitoring Equipment', slug: 'wildlife-monitoring' },
  ...
  { id: 'tree-health', name: 'Tree & Forest Health Equipment', slug: 'tree-health' },
  { id: 'nursery-plantation', name: 'Nursery & Plantation Equipment', slug: 'nursery-plantation' },
  ...
  { id: 'field-expedition', name: 'Field & Expedition Equipment', slug: 'field-expedition' },
...
export const forestTagsBySubcategory: Record<string, string[]> = {
  ...
  'wildlife-monitoring': ['Camera Traps', 'Infrared Camera Traps', 'Cellular Camera Traps', 'Acoustic Monitoring Devices', 'Bat Detectors', 'Thermal Cameras', 'Night Vision Devices', 'Binoculars', 'Spotting Scopes', 'Wildlife Tracking Equipment'],
  ...
  'remote-sensing': ['Drones', 'Thermal Drones', 'Mapping Drones', 'LiDAR', 'GNSS Survey Equipment', 'GIS Systems', 'Laser Scanners'],
  'field-expedition': ['GPS', 'Compasses', 'Rangefinders', 'Headlamps', 'Field Radios', 'Rugged Tablets', 'Portable Power Stations', 'Solar Chargers', 'Equipment Bags'],
