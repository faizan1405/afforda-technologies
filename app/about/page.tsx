    ...
    <main id="top" className="detail-page">
      ...
      <section className="product-detail-hero" style={{ padding: '8rem 2rem 4rem', minHeight: '60vh' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <h1>Field Technology & Equipment.</h1>
          <div style={{ fontSize: '1.25rem', lineHeight: '1.6', margin: '2rem 0', color: 'var(--text)', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <p>
              Our focus is on reliable technology, practical applications and helping customers select suitable equipment. We specialize in product sourcing and consultation for India-focused operations.
            </p>
          </div>
        </div>
      </section>
